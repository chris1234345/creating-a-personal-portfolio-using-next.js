  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <h2 className="font-serif text-3xl text-center mt-6 md:text-3xl">Featured Projects</h2>
        <p className="text-center text-white/60 mt-4 md:text-lg max-w-md mx-auto lg:text-xl">See how I transformed concepts into engagins digital experiences.</p>
        <div className="flex flex-col mt-10 gap-20 md:mt-20 ">
          {portfolioProjects.map(project => (
            <div className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 pt-8 px-8 after:pointer-events-none md:pt-12 md:px-10 lg:pt-16 lg:px-20" key={project.title}>
             ...
             <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <h3 className="font-serif text-2xl mt-2 md:text-4xl md:md-5">{project.title}</h3>
              <hr className="border-t-2 border-white/5 mt-4 md:mt-5"/>
              <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                {project.results.map(result => (
                  <li className="flex gap-2 text-sm text-white/50 first-letter:md:text-base">
